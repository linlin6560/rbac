            ...
            <el-card>
                ...
                <div>
                    <div style="text-align: center">
                        <el-avatar :src="sysAdminInfo.icon"></el-avatar>
                    </div>
                        ...
                        <el-form :model="sysAdminInfo" :rules="editFormRules" ref="editFormRefForm" label-width="80px">
                            <el-form-item label="用户头像" prop="icon">
                                <el-upload :headers=headers class="avatar-uploader" :action="uploadIconUrl"
                                    ...
                                    <img v-else="!icon" :src="sysAdminInfo.icon" class="avatar" title="点击更换头像">
                                </el-upload>
                            </el-form-item>
...
const uploadIconUrl = ref('http://localhost:3001/api/dev/common/fileUpload')
const headers = ref({
